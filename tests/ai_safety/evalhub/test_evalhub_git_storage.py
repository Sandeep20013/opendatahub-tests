...
class TestEvalHubGitStoragePrivate:
    ...
    def test_private_repo_job_e2e(
        ...
        assert commit_sha, f"Expected resolved_sha in benchmarks[0].test_data_ref, got: {test_data_ref}"
        assert re.fullmatch(r"[0-9a-f]{40}", commit_sha), f"Expected 40-char hex SHA, got: {commit_sha}"
