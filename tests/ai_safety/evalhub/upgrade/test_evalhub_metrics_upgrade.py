...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            {"name": "test-evalhub-metrics-upgrade"},
        ),
    ],
    indirect=True,
)
...
class TestEvalHubMetricsPreUpgrade:
    """Tests for the EvalHub Prometheus metrics endpoint."""
    @pytest.mark.pre_upgrade
    def test_evalhub_metrics_endpoint_pre_upgrade(
        self,
    ...
    @pytest.mark.pre_upgrade
    def test_evalhub_metrics_recorded_for_requests_pre_upgrade(
        self,
        current_client_token: str,
        evalhub_ca_bundle_file: str,
        evalhub_route: Route,
...
@pytest.mark.tier1
@pytest.mark.ai_safety
class TestEvalHubMetricsPostUpgrade:
    """Tests for the EvalHub Prometheus metrics endpoint."""
    @pytest.mark.post_upgrade
    def test_evalhub_metrics_endpoint_post_upgrade(
        self,
        current_client_token: str,
        evalhub_ca_bundle_file: str,
        evalhub_route: Route,
    ...
    @pytest.mark.post_upgrade
    def test_evalhub_metrics_recorded_for_requests_post_upgrade(
        self,
        current_client_token: str,
        evalhub_ca_bundle_file: str,
        evalhub_route: Route,
